...
/// <summary>
/// Omuz fleksiyon tekrar politikası: hedefte tutma + formüllü alt eşik.
/// Refactor only — klinik eşik formülü değişmedi. SaMD Class B; teşhis değildir.
/// </summary>
public sealed class ShoulderFlexionRepPolicy : IRepPolicy
{
    ...
    public void Reset()
    {
        // ArmRepState host'ta sıfırlanır; burada yalnızca hedef korunur.
    }
    ...
    /// <summary>
    /// Düşük hedef (20°): alt ≈ 4–12°. Yüksek hedef (160°): alt ≈ 45° tavan.
    /// </summary>
